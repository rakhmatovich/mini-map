        ...
        >
            {selectedFeature && (
                <div className="flex-1">
                    {isEditing ? (
                        <form onSubmit={handleUpdateFeature} data-test-id="update-form">
                            <div>
                                <label>Details:</label>
                                <textarea
                                    data-test-id="popup-details"
                                    value={editDetails}
            ...
            <div className="flex flex-col gap-1">
                <button ref={popupCloserRef} data-test-id="popup-closer" className="popup-btn">
                ...
                {!isEditing && (
                    <button onClick={() => setIsEditing(true)} data-test-id="popup-edit" className="popup-btn">
                        <svg
                            width="18px"
                            height="18px"
                            viewBox="0 0 24 24"
